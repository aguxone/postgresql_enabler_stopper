...
CXXFLAGS=-s -mthreads -mwindows
### IT HAS STATIC INCLUDES
CXXINCLUDES=-I../../librerias_cpp/wx3_2_0/include -I../../librerias_cpp/wx3_2_0/lib_release_static/mswu
CXXLIBS=-L../../librerias_cpp/wx3_2_0/lib_release_static 
# -lwxmsw32u_core -lwxbase32u

############################################
###### STATIC BUILD additional parameters
##########################################

# core and base are fundamental ones and their static versions
STATICWXLIBS= -static -lwxmsw32u_core -lwxbase32u -lwxpng -lwxzlib -lwxtiff -lwxjpeg -lwxregexu -lwxmsw32u_aui -lwxmsw32u_adv 
WXWINDEPLIBS= -lkernel32 -luser32 -lgdi32 -lwinspool -lcomdlg32 -ladvapi32 -lshell32 -lole32 -loleaut32 -luuid -lcomctl32 -lwsock32 -lodbc32 -lshlwapi -lversion -loleacc -luxtheme
############################################
